...
extension UIAlertController {
    ...
    public func addLocalePicker(type: LocalePickerViewController.Kind, prevValue: LocaleInfo?, selection: @escaping LocalePickerViewController.Selection) {
        var info: LocaleInfo?
